...
public class DownloadDetails extends AsyncTask<Void, Void, MetaData> {
    ...
    private String url;
    private final String multipleDownload = "DownloadDetails";
    ...
    public DownloadDetails(Context context, JsonUtils utils,OnEventListener callback) {
        mCallBack = callback;
        mContext = context;
        jsonUtils = utils;
    }
